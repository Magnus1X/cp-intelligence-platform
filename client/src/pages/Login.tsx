        ...
        <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-zinc-400 mt-2">Enter your credentials to access your intelligence dashboard</p>
                </div>
                ...
                <p className="mt-8 text-center text-zinc-400">
                    New to the platform?{' '}
                    <Link to="/register" className="text-primary hover:text-primary/80 font-medium">Create an account</Link>
                </p>
            </motion.div>
        </div>
    );
